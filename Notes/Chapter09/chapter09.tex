...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{equation*}
        \item Thus, in this case, the internal forces do no work (which makes sense for a rigid body).
        \item Thus, the KE is just related to the external forces, as shown above.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{align*}
        \begin{itemize}
            \item The left equation above comes from dividing $I_1pa_1+(I_3-I_2)a_2\omega_3=0$ through by $a_2$ and rearranging.
            \item The right equation above comes from dividing $I_2pa_2+(I_1-I_3)\omega_3a_1=0$ through by $a_2$ and rearranging.
        \end{itemize}
    ...
    \begin{itemize}
        \item Consider a rectangular prism with longest axis $a$, second longest $b$, and third longest $c$.

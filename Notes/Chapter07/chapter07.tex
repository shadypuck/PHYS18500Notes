...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item It follows, from the above and the fact that $\vec{r}_i=\vec{R}+\vec{r}_i{}^*$, that if the velocity of the center of mass is $\dot{\vec{R}}$, then we have
        \begin{align*}
            \vec{p}_1 &= m_1\dot{\vec{r}}_1 = m_1\dot{\vec{R}}+\vec{p}{\,}^*&
            \vec{p}_2 &= m_2\dot{\vec{r}}_2 = m_2\dot{\vec{R}}-\vec{p}{\,}^*
        \end{align*}
        \item It follows from the above definitions of the three descriptors of the system that the total momentum, angular momentum, and kinetic energy in the CM frame are
        \begin{align*}
            \vec{P}^* &= 0&
